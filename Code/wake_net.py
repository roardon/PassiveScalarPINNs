...
for k in range(4):
  ...
  dde.saveplot(losshistory, train_state, issave=True, isplot=False, loss_fname="wake_net_loss_"+str(100+((k%2)*20))+"_"+str(8+(k//2)), output_dir="Losses")
  model.save("models/wake_net_" + str(100+((k%2)*20)) + "_" + str(8+(k//2)))
