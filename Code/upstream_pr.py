...
for k in range(len(Prs)):
  ...
  dde.saveplot(losshistory, train_state, issave=True, isplot=False, loss_fname="upstream_pr_loss_"+Prstxt[k], output_dir="Losses")
  model.save("models/upstream_pr_" + Prstxt[k])
