...
for k in range(1, 11):
  ...
  dde.saveplot(losshistory, train_state, issave=True, isplot=False, loss_fname="upstream_data_loss_"+str(k), output_dir="Losses")
  model.save("models/upstream_data_" + str(k))
