...
for k in range(1, 11):
  ...
  grid_x, grid_y = np.mgrid[-14.75:39.85:56j, -9.9:9.9:21j]
  ...
  grid_x2, grid_y2 = np.mgrid[-14.75:39.85:(55j*k)+1j, -9.9:9.9:(20j*k)+1j]
  ...
  x_line2 = np.linspace(-14.75, 39.85, num_x2)
  y_line2 = np.linspace(-9.9, 9.9, num_y2)
  ...
  [t_x_training, t_y_training, dummy_u, dummy_v, t_training] = \
      generate_training_points(new_x2, new_y2, new_t, new_t, new_t)
  ...
  dde.saveplot(losshistory, train_state, issave=True, isplot=False, loss_fname="upstream_temp_loss_"+str(k), output_dir="Losses")
  model.save("models/upstream_t_" + str(k))
